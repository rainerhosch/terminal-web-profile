...
export default function TerminalContent() {
    ...
    const handleCommand = (command) => {
        const output = COMMANDS[command] || `Command not found: ${command}. Type \`help\` for a list of commands.`;
        setHistory(prev => [
            ...prev,
    ...
    return (
        <div className="p-4 text-green-400 h-[calc(100%-40px)] overflow-y-auto">
            <div className="mb-2">
                <TypingEffect text="Hello, and welcome to my portfolio! Type `help` to get started." />
            </div>
